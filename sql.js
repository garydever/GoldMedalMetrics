...
if (field) {
  if (sortAscending) {
    sortString = `SELECT * FROM GoldMedal WHERE country = '${country}' ORDER BY ${field} ASC;`;
  } else {
    sortString = `SELECT * FROM GoldMedal WHERE country = '${country}' ORDER BY ${field} DESC;`;
  }
} else {
  sortString = `SELECT * FROM GoldMedal WHERE country = '${country}';`
} 
